    ...
    return (
        ...
        <div className={`container font-[poppins] ${showChatBot ? "show-chatbot" : ""} flex justify-center items-center rounded-xl z-10`}>
            ...
            <div className="chat-bg absolute opacity-0 pointer-events-none -bottom-10 h-[80vh] w-[90vw] md:w-[80vw] flex items-center justify-center bg-black/60 backdrop-blur-sm bg-opacity-50 rounded-xl transition-all duration-100 ease-in z-10">
                {/* ChatBot */}
                    <div className="chatbot-popup absolute opacity-0 pointer-events-none bottom-0 md:bottom-4 left-1/2 -translate-x-1/2 w-[90vw] md:w-[60vw] h-[80vh] md:h-[95%] overflow-hidden bg-[#fff] rounded-xl md:rounded-lg shadow-lg transition-all duration-100 ease-in z-10">
                    {/* ChatBox header  */}
                    ...
                    {/* Chat body */}
                    <div ref={chatBotRef} className="chat-body h-[60vh] md:h-[385px] overflow-y-auto py-6 px-4 md:p-6 mb-16 flex flex-col gap-5 bg-gray-800">
