...
function ChatBot() {
    ...
    return (
        ...
        <div className={`container font-[poppins] ${showChatBot ? "show-chatbot" : ""} flex justify-center items-center bg-green-500`}>
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-white/40 backdrop-blur-none bg-opacity-50 rounded-md">
                <div className="chatbot-popup absolute opacity-0 pointer-events-none bottom-0 sm:bottom-10 left-1/2 -translate-x-1/2 w-full sm:w-[320px] h-screen sm:h-max overflow-hidden bg-[#fff] rounded-none sm:rounded-lg shadow-lg transition-all duration-100 ease-in">
                    {/* ChatBox header  */}
                    <div className="chat-header flex px-4 sm:px-6 py-3 sm:py-4 items-center justify-between bg-[#1570bf]">
                        <div className="header-info flex gap-3 items-center">
                            ...
                            <ChatBotIcon />
                            <h2 className="logo-text text-[#fff] font-bold text-lg sm:text-2xl">ChatBot</h2>

                        </div>
                        <button onClick={changeBtn} className="material-symbols-outlined h-10 w-10 border-none outline-none text-[#fff] cursor-pointer text-2xl pt-1 rounded-full -mr-2 bg-none hover:bg-[#1553bf] transition-all duration-200 ease-in-out ">keyboard_arrow_down</button>
                    </div>

                    {/* Chat body */}
                    <div ref={chatBotRef} className="chat-body h-[325px] overflow-y-auto py-6 px-4 sm:p-6 mb-16 flex flex-col gap-5">
                        <div className="massage bot-massage flex gap-3 items-center">
                            ...
                            <p className="massage-text px-4 py-3 max-w-[75%] text-base sm:text-base bg-[#f6f2ff]">
