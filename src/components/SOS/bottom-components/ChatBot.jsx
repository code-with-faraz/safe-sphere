...
function ChatBot() {
    ...
    return (
        ...
        <div className={`container font-[poppins] ${showChatBot ? "show-chatbot" : ""} flex justify-center items-center rounded-xl`}>
            ...
            <div className="chat-bg absolute opacity-0 pointer-events-none -bottom-10 h-[80vh] w-[80vw] flex items-center justify-center bg-black/60 backdrop-blur-sm bg-opacity-50 rounded-xl transition-all duration-100 ease-in">
                {/* ChatBot */}
                    ...
                    {/* Chat body */}
                    <div ref={chatBotRef} className="chat-body h-[385px] overflow-y-auto py-6 px-4 sm:p-6 mb-16 flex flex-col gap-5 bg-gray-800">
                        <div className="massage bot-massage flex gap-3 items-center">
                            ...
                            <p className="massage-text px-4 py-3 max-w-[75%] text-base sm:text-base bg-gray-700 text-[#fff]">
