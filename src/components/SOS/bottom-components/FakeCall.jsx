            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-white/40 backdrop-blur-none bg-opacity-50 rounded-md">
                    <div className="bg-white/80 backdrop-blur-sm  py-12 px-16 rounded-lg shadow-lg text-black flex flex-col gap-1">
                        ...
                        <button onClick={() => navigate('/fake-call?caller=anonymous')} className="block w-full py-2 px-4 bg-gray-500 hover:bg-gray-600 text-white rounded-tl-xl rounded-br-xl mb-2 hover:scale-105 transition-all duration-500 ease-in-out">📞 Unknown Caller</button>
                        ...
                        {/* Close Button */}
                        <button type="button" title="close" class="close-btn bg-[#c1c1c1] hover:bg-[#e81022] w-6 h-6 absolute flex justify-center items-center rounded-full p-2 right-4 top-4 hover:rotate-90 duration-300 ease-in-out hover:scale-105 group">
