            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-md rounded-xl">
                    <div className="bg-[#0f0f0f] py-12 px-16 rounded-lg shadow-lg text-[#39ff14] flex flex-col gap-4 neon-border">
                        ...
                        {/* Close Button */}
                        <button onClick={closeModal} type="button" title="close" className="close-btn bg-[#dfdfdf] hover:bg-[#e81022] w-7 h-7 absolute flex justify-center items-center rounded-full p-2 right-4 top-4 hover:rotate-90 duration-300 ease-in-out hover:scale-110 group neon-glow">
